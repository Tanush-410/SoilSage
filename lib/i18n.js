...
const T = {
  en: {
    ...
    // Yield Price
    yieldPrice: 'Market & Yield', yieldPriceSub: 'Per-crop yield estimates · MSP/APMC 2024-25 market rates · Efficiency-adjusted',
  ...
  kn: {
    ...
    // Yield Price
    yieldPrice: 'ಮಾರುಕಟ್ಟೆ & ಇಳುವರಿ', yieldPriceSub: 'ಬೆಳೆವಾರು ಇಳುವರಿ ಅಂದಾಜು · MSP/APMC 2024-25 ಬೆಲೆಗಳು · ದಕ್ಷತೆ ಆಧಾರಿತ',
